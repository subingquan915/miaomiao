        ...
        <!-- <div class="detail_list">
            ...
            <div class="detail_list_content">
                <div class="detail_list_img">
                    <img src="/static/images/movie_1.jpg" alt="">
                </div>
        ...
        <div class="detail_player swiper-container">
            <ul class="swiper-wrapper">
                <li class="swiper-slide">
                    <div>
                        <img src="/static/images/person_1.webp" alt="">
                    </div>
                    <p>陈建斌</p>
                    <p>马先勇</p>
                </li>
...
#detailContrainer.slide-enter-active{ animation: 0.3s slideMovie;}
...
.detail_list .detail_list_bg{ width:100%; height:100%; background: url(/static/images/movie_1.jpg) 0 40%;  background-size:cover; position: absolute; left: 0; top: 0;}
